...
<?php
    if(isset($_POST['submit']))
    {
        ...
        if(mysqli_num_rows($consulta) < 1)
        {
            ...
            $cadastro = mysqli_query($conexao, "INSERT INTO tbl_vendas(nome,cpf,cep,telefone,placa,marca,modelo,ano,valor,pagamento,data_venda)
            VALUES ('$nome','$cpf','$cep','$telefone','$placa','$marca','$modelo','$ano','$valor','$pagamento','$data_venda')");
